...
import shared.ui.UiDialogs;
import shared.ui.UiIcon;
...
import admin.model.TransactionTotals;
...
public final class AdminDashboardPanel extends JPanel {
    ...
    public void showFor(Admin admin) {
        currentAdmin = admin;
    ...
    private void showReport(SystemReport report) {
        ...
        for (shared.model.TransactionType type : shared.model.TransactionType.values()) {
