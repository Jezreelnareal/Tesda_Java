...
public final class UiTheme {
    ...
    public static final Font FONT_MEDIUM = new Font("Segoe UI Semibold", Font.BOLD, 14);
    public static final Font FONT_TITLE = new Font("Segoe UI", Font.BOLD, 28);
    public static final Font FONT_BALANCE = new Font("Segoe UI", Font.BOLD, 34);
    ...
    public static JButton themeButton(Window owner) {
    ...
    public static void installPasswordVisibilityToggle(JPasswordField field) {
    ...
    public static void setNavigationActive(JButton active, Iterable<JButton> buttons) {
    ...
    public static final class RoundedPanel extends JPanel {
        ...
        public RoundedPanel(Color fillColor, int arc) {
